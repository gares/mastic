...
let ErrorToken.Registered { of_token } = ErrorToken.register {
...
type t = Assign of string * Expr.t | If of Expr.t * t * t option | Err of t Error.t
[@@deriving show]
let is_err = function Err _ -> true | _ -> false
...
type t = Fun of string * Cmd.t list | Err of t Error.t
[@@deriving show]
let is_err = function Err _ -> true | _ -> false
...
module Prog = struct
  ...
  type t = P of Func.t list | Err of t Error.t
  [@@deriving show]
let is_err = function Err _ -> true | _ -> false
